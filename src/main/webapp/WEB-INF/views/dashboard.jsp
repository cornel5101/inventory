				...
				<div class="card">
					<div class="card-body">
						...
						<a href="#" class="btn btn-primary btn-sm " data-toggle="modal"
							data-target="#categorymodal">Add</a> <a
							href="${pageContext.request.contextPath}/manage_category"
						...
						<div id="category_form" onsubmit="return false">
							<div class="form-group">
								<label>Category Name</label>
								 <input type="text"
									class="form-control" path="categoryName" id="category_name"
									placeholder="Enter Category" />
							</div>
							<div class="form-group">
								<label>Parent Category</label> 
								<select class="form-control" path="parentCat" id="parent_cat">
										<option value="0">${parentCat}</option>
								</select>
